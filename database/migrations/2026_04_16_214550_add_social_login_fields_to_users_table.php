<?php
// database/migrations/xxxx_xx_xx_xxxxxx_add_social_login_fields_to_users_table.php
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            // Add generic provider fields (for future GitHub, Facebook, etc.)
            $table->string('provider_name')->nullable()->after('google_refresh_token');
